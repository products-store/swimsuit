document.addEventListener('DOMContentLoaded', () => {
    ...
    const DISCORD_WEBHOOK_URL = 'https://discord.com/api/webhooks/1522699422360928346/IcArpZWvKcjgPfyaqywAphT6Vp2IJx87pjmpUQIXMG67uLTRCQ2ygvWAnRwZsADTEwzG';

    // Google Sheets Web App URL
    const GOOGLE_SHEETS_URL = 'https://script.google.com/macros/s/AKfycbxVsKgHo4kFnW20K8qRJkYs0GEYQwLSuBHnRKrX6ngFvPCkC7fZb6Vpb5InYOPUin80xQ/exec';
...
const sendToDiscordWebhook = async (order) => {
    ...
    quickOrderForm.addEventListener('submit', async (event) => {
        ...
        const selectedSize = selectedSizeBtn ? selectedSizeBtn.dataset.size : 'taille1';
        const quantity = parseInt(quantityInput.value) || 1;
...
const orderItem = {
    id: `black-${selectedSize}`,
    name: productDetails.name,
    color: 'اسود',
    size: selectedSize === 'taille1' ? 'Taille 1' : selectedSize === 'taille2' ? 'Taille 2' : 'Taille 3',
    price: productPrice,
    quantity: quantity,
    image: productDetails.colors['black'].main
};
